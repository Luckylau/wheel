...
import com.luckylau.wheel.common.uti.ClassUtils;
import com.luckylau.wheel.common.uti.MapUtil;
...
public class NotifyCenter {
    ...
    private static Class<? extends EventPublisher> clazz = DefaultPublisher.class;
    ...
    static {
        ...
        DEFAULT_PUBLISHER_FACTORY = (cls, buffer) -> {
            try {
                ...
                throw new BaseRuntimeException(SERVER_ERROR, ex);
            }
        };
